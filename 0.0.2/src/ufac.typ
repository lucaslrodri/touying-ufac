    ...
    context (
      block(
        ...
        utils.call-or-display(self, inline-box(
          {
            if type == "example" {
              [#self.info.example-name #self.info.counter-prefix#_example-counter.display()#src]
            } else if type == "exercise" {
              [#self.info.task-name #self.info.counter-prefix#_exercise-counter.display()#src]
            }
          },
          color: color,
